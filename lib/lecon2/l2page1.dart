...
import 'package:exerfrancais/lecon2/l2page2.dart';
import 'package:awesome_dialog/awesome_dialog.dart';
import 'dart:async';
//import 'package:audioplayers/audioplayers.dart';
class Page1lc2 extends StatefulWidget
{
...
class _Page1State extends State<Page1lc2>
{
  ...
  Future p2() async {
    stopplay();
    await player.setAsset('assets/medias/lecon2/elleTisse.mp3');
    await player.play();
  }
    ...
    showDialog(
      ...
      builder: (BuildContext context)
      {
        ...
        return AlertDialog(
          ...
          content: Text("Lisez la page 34 du Syllabaire. La première image représente une «tasse». Un objet cylindrique qui sert à boire. Sara a une tasse. «Elle tisse» pour avoir des habits", style:TextStyle(color:  Colors.black54),),
          actions: <Widget>[
            TextButton(
      ...
      child:BottomAppBar(
        ...
        child: new Row(
          ...
          children: <Widget>[
            ...
            ///  if(isRightSara && vrai==1){
                setState(() {
                  Navigator.of(context).pushNamed('/page2lc2');
                  /* Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) =>
                                    ...
                                    children: <Widget>[
                                      Card(
                                        ...
                                        child: new Container(
                                            height: hautimg,
                                            width: largimg,
                                            child: Image.asset("assets/medias/lecon2/tasseCoul.png")
                                        ),
                                      ...
                                      Ink(
                                        ...
                                        child:  Text("tasse", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 16.0),),
                                      ),
                                      /// nom image
                                    ...
                                    children: <Widget>[
                                      Card(
                                        ...
                                        child: new Container(
                                            height: hautimg,
                                            width: largimg,
                                            child: Image.asset("assets/medias/lecon2/elleTisseCoul.png")
                                        ),
                                      ...
                                      Ink(
                                        ...
                                        child:  Text("elle tisse", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 16.0),),
                                      ),
                                      /// nom image
                                  ...
                                  child:ElevatedButton(
                                    ...
                                    style: ElevatedButton.styleFrom(
                                        ...
                                        textStyle: TextStyle(
                                          fontSize: 16,
                                          fontWeight: FontWeight.bold,
                                          color:isRightElleRira? Color.fromRGBO(253, 134, 152, 1.0): Color.fromRGBO(239, 243, 246, 1.0),
                                        )),
