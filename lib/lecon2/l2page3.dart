...
import 'package:exerfrancais/lecon2/l2page4.dart';
import 'package:awesome_dialog/awesome_dialog.dart';
import 'dart:async';
//import 'package:audioplayers/audioplayers.dart';
class Page3lc2 extends StatefulWidget
{
...
class _Page3State extends State<Page3lc2>
{
    ...
    showDialog(
      ...
      builder: (BuildContext context)
      {
        ...
        return AlertDialog(
          ...
          content: Text('Lisez les cases de la Leçon 2.  «rit» commence par  «ri» et se termine par «t» mais le t final ne se prononce pas. le mot rit est composé d\' une syllabe.  Quand un mot est composé d\'une syllabe, il ne se décompose pas.',style:TextStyle(color:  Colors.black54),),
        ...
        child: new Row(
          ...
          children: <Widget>[
            ...
            IconButton(icon: Icon(Icons.arrow_forward_ios), onPressed: () {
              //if((_radioValue1==2 && _radioValue2==0) && _radioValue3==2){
                setState(() {
                  Navigator.of(context).pushNamed('/page4lc2');
                 /* Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) =>
                                          ...
                                          Center(
                                              ...
                                              Row(
                                                ...
                                                children: <Widget>[
                                                  //Text('Badges:'),
                                                  // for (int i = 0; i < 5; i++)
                                                  _getExampleBadge(padding: (6).toDouble(),text:"Rita"),
                                                 /* new Padding(
                                              ...
                                              Container(
                                                ...
                                                new Row(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"ita"),
                                                    ]
                                                ),),
                                              //photo
                                              //icone de son
                                          ...
                                          Center(
                                              ...
                                              Row(
                                                ...
                                                children: <Widget>[
                                                  //Text('Badges:'),
                                                  // for (int i = 0; i < 5; i++)
                                                  _getExampleBadge(padding: (6).toDouble(),text:"Arras"),
                                                  /*new Padding(
                                              ...
                                              Container(
                                                ...
                                                new Row(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"Ar"),
                                                      Text("+", style: TextStyle(color:Color.fromRGBO(142, 156, 168, 1.0), fontWeight: FontWeight.bold),),
                                              ...
                                              Container(
                                                ...
                                                new Row(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"A"),
                                                      Text("+", style: TextStyle(color:Color.fromRGBO(142, 156, 168, 1.0), fontWeight: FontWeight.bold),),
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"r"),
                                                      Text("+", style: TextStyle(color:Color.fromRGBO(142, 156, 168, 1.0), fontWeight: FontWeight.bold),),
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"ras"),]
                                          ...
                                          Center(
                                              ...
                                              Row(
                                                ...
                                                children: <Widget>[
                                                  //Text('Badges:'),
                                                  // for (int i = 0; i < 5; i++)
                                                  _getExampleBadge(padding: (6).toDouble(),text:"rit"),
                                                  /*new Padding(
                                              ...
                                              Container(
                                                ...
                                                new Row(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"rit"),
                                                     ]
                                                ),),
                                              //photo
                                              //icone de son
