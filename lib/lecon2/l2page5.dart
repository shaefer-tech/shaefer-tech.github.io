...
import 'package:exerfrancais/lecon2/l2page6.dart';
import 'package:badges/badges.dart';
import 'package:awesome_dialog/awesome_dialog.dart';
import 'dart:async';
//import 'package:audioplayers/audioplayers.dart';
class Page5lc2 extends StatefulWidget
{
...
class _Page5State extends State<Page5lc2>
{
  ...
  Widget build(BuildContext context) {
          ...
          children: <Widget>[
            ...
            IconButton(icon: Icon(Icons.arrow_forward_ios), onPressed: () {
              //if(_radioValue1==0 && _radioValue2==2) {
                setState(() {
                  Navigator.of(context).pushNamed('/page6lc2');
                  /*Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) =>
    ...
    return new Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        if(_radioValue1==0 && _radioValue2==2) {   AwesomeDialog(
          context: context,
