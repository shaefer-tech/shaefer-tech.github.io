...
import 'package:exerfrancais/lecon2/l2pageRappel.dart';
import 'package:awesome_dialog/awesome_dialog.dart';
import 'dart:async';

import 'package:just_audio/just_audio.dart';
//import 'package:audioplayers/audioplayers.dart';
class Page2lc2 extends StatefulWidget
{
...
class _Page2State extends State<Page2lc2>
{
  ...
  Future p1() async {
    stopplay();
    await player.setAsset('assets/medias/lecon2/saste.mp3');
    await player.play();
  }
  Future p2() async {
    stopplay();
    await player.setAsset('assets/medias/lecon2/setas.mp3');
    await player.play();
  }

  Future p3() async {
    stopplay();
    await player.setAsset('assets/medias/lecon2/tasse.mp3');
    await player.play();
  }
  Future p4() async {
    stopplay();
    await player.setAsset('assets/medias/lecon2/setis.mp3');
    await player.play();
  }
  Future p5() async {
    stopplay();
    await player.setAsset('assets/medias/lecon2/tisse.mp3');
    await player.play();
  }
  Future p6() async {
    stopplay();
    await player.setAsset('assets/medias/lecon2/siste.mp3');
    await player.play();
  }
  Future p7() async {
    stopplay();
    await player.setAsset('assets/medias/lecon2/elle.mp3');
    await player.play();
  }
  Future p8() async {
    stopplay();
    await player.setAsset('assets/medias/lecon2/lele.mp3');
    await player.play();
  }
  Future p9() async {
    stopplay();
    await player.setAsset('assets/medias/lecon2/elele.mp3');
    await player.play();
  }
    ...
    showDialog(
      ...
      builder: (BuildContext context)
      {
        ...
        return AlertDialog(
          ...
          content:
             Text('tasse peut se décomposer en deux syllabbes: «tas» et «se». «tasse» commence par  «tas». Certaines combinaisons de l\'exercice n\'ont aucun sens en français.', style:TextStyle(color:  Colors.black54),),
      ...
      child: BottomAppBar(
        ...
        child: new Row(
          ...
          children: <Widget>[
           ...
           //   if((_radioValue1==2 && _radioValue2==1)&& _radioValue3==0){
                setState(() {
                  Navigator.of(context).pushNamed('/pageRappelc2');
                 /* Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) =>
                                 ...
                                 // color:Color.fromRGBO(239, 243, 246, 1.0),
                                  child:Column(
                                    children: <Widget>[
                                        ...
                                        //Text('Badges:'),
                                       // for (int i = 0; i < 5; i++)
                                                     _getExampleBadge(padding: (6).toDouble(),text:"tas + se"),
                                                   new Padding(
                                                ...
                                                Container(
                                                  ...
                                                  child:
                                                     new Row(
                                                        ...
                                                        _getExampleBadgeElse(padding: (4).toDouble(),text:"saste"),]
                                                  ),),
                                    //photo
                                    //icone de son
                                                /*Container(
                                  ...
                                  // mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                               ...
                                               children: <Widget>[
                                                ...
                                                _getExampleBadgeElse(padding: (4).toDouble(),text:"setas"),]
                                                       ),),
                                    //photo
                                    //icone de son
                                                /* Container(
                                                   ...
                                                   child:
                                                       new Row(
                                                          ...
                                                          new Radio(
                                                           ...
                                                           _getExampleBadgeElse(padding: (4).toDouble(),text:"tasse"),]
                                                     ),),
                                    //photo
                                    //icone de son
                                                /* Container(
                                         ...
                                         Container(
                                          ...
                                          new Row(
                                              ...
                                              children: <Widget>[
                                                ...
                                                _getExampleBadgeElse(padding: (4).toDouble(),text:"setis"),]
                                          ),),
                                          //photo
                                          //icone de son
                                            ...
                                            child:
                                             new Row(
                                              ...
                                              children: <Widget>[
                                                ...
                                                _getExampleBadgeElse(padding: (4).toDouble(),text:"tisse"),]
                                          ),),
                                          //photo
                                          //icone de son
                                          /*Container(
                                        ...
                                        Container(
                                          ...
                                          new Row(
                                              ...
                                              children: <Widget>[
                                                ...
                                                _getExampleBadgeElse(padding: (4).toDouble(),text:"siste"),]
                                          ),),
                                          //photo
                                          //icone de son
