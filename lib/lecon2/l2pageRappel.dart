...
import 'package:exerfrancais/lecon2/l2page3.dart';
import 'package:awesome_dialog/awesome_dialog.dart';
import 'dart:async';

import 'package:just_audio/just_audio.dart';
//import 'package:audioplayers/audioplayers.dart';
class PageRapelc2 extends StatefulWidget
{
...
class _PageRState extends State<PageRapelc2>
{
  ...
  Future p1() async {
    stopplay();
    await player.setAsset('assets/medias/lecon2/a.mp3');
    await player.play();
  }
  Future p2() async {
    stopplay();
    await player.setAsset('assets/medias/lecon2/ta.mp3');
    await player.play();
  }

  Future p3() async {
    stopplay();
    await player.setAsset('assets/medias/lecon2/aprepo.mp3');
    await player.play();
  }
  Future p4() async {
    stopplay();
  ...
  Future p5() async {
    stopplay();
    await player.setAsset('assets/medias/lecon2/i.mp3');
    await player.play();
  }
  Future p6() async {
    stopplay();
    await player.setAsset('assets/medias/lecon2/ri.mp3');
    await player.play();
  }
  Future p7() async {
    stopplay();
  ...
  Future p9() async {
    stopplay();
    await player.setAsset('assets/medias/lecon2/ti.mp3');
    await player.play();
  }
  Future p10() async {
    stopplay();
    ...
    showDialog(
      ...
      builder: (BuildContext context)
      {
        ...
        return AlertDialog(
          ...
          content: Text("Lisez les cases de la Leçon 2. La syllabe est un fractionnement du mot parlé pour analyser de ses constituants.", style:TextStyle(color:  Colors.black54),),
          actions: <Widget>[
            TextButton(
                                              ...
                                              Container(
                                                ...
                                                new Row(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      Text("à", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 17.0),),
