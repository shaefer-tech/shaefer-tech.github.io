...
import 'package:exerfrancais/lecon2/l2page7.dart';
import 'package:badges/badges.dart';
import 'package:awesome_dialog/awesome_dialog.dart';
import 'dart:async';
//import 'package:audioplayers/audioplayers.dart';
class Page6lc2 extends StatefulWidget
{
...
class _Page6State extends State<Page6lc2>
{
    ...
    showDialog(
      ...
      builder: (BuildContext context)
      {
        ...
        return AlertDialog(
          ...
          content: Text("Lisez le texte étudié dans la leçon 2 du syllabaire", style:TextStyle(color:  Colors.black54),),
          actions: <Widget>[
            TextButton(
        ...
        child: new Row(
          ...
          children: <Widget>[
            ...
            IconButton(icon: Icon(Icons.arrow_forward_ios), onPressed: () {
             // if((_radioValue1==0 && _radioValue2==1) && _radioValue3==0){
                setState(() {
                  Navigator.of(context).pushNamed('/page7lc2');
                 /* Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) =>
                                          ...
                                          Center(
                                              ...
                                              Row(
                                                ...
                                                children: <Widget>[
                                                  //Text('Badges:'),
                                                  // for (int i = 0; i < 5; i++)
                                                  Text("Sara a une ________ .", style: TextStyle(color:Color.fromRGBO(142, 156, 168, 1.0), fontWeight: FontWeight.bold, fontSize: 17.0),),
                                                ],
                                              )
                                              ...
                                              Container(
                                                ...
                                                new Row(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"tessa"),]
                                                ),),
                                              //photo
                                              //icone de son
                                              ...
                                              Container(
                                                ...
                                                new Row(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"asset"),]
                                                ),),
                                              //photo
                                              //icone de son
                                          ...
                                          Center(
                                              ...
                                              Row(
                                                ...
                                                children: <Widget>[
                                                  //Text('Badges:'),
                                                  // for (int i = 0; i < 5; i++)
                                                  Text("Elle est à Arras et ______ tisse. ", style: TextStyle(color:Color.fromRGBO(142, 156, 168, 1.0), fontWeight: FontWeight.bold, fontSize: 17.0),),
                                                ],
                                              )
                                          ...
                                          Center(
                                              ...
                                              Row(
                                                ...
                                                children: <Widget>[
                                                  //Text('Badges:'),
                                                  // for (int i = 0; i < 5; i++)
                                                  Text("Sara ne tisse ____________.", style: TextStyle(color:Color.fromRGBO(142, 156, 168, 1.0), fontWeight: FontWeight.bold, fontSize: 17.0),),
                                                ],
                                              )
                                              ...
                                              Container(
                                                ...
                                                new Row(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"asp"),]
                                                ),),
                                              //photo
                                              //icone de son
                                              ...
                                              Container(
                                                ...
                                                new Row(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"sap"),]
                                                ),),
                                              //photo
                                              //icone de son
      ...
      floatingActionButton: FloatingActionButton(
        ...
        if((_radioValue1==0 && _radioValue2==1) && _radioValue3==0){
          ...
          AwesomeDialog(
             ...
             // btnOkOnPress: () {  Navigator.of(context).pop();  Navigator.of(context).pop();},
