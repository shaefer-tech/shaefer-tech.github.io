...
import 'package:exerfrancais/lecon1/l1page4.dart';
import 'package:awesome_dialog/awesome_dialog.dart';
import 'dart:async';
//import 'package:audioplayers/audioplayers.dart';
class Page3lc1 extends StatefulWidget
{
...
class _Page3State extends State<Page3lc1>
{
  /*Questions questions;
  ...
  Future p1() async {
    stopplay();
    await player.setAsset('assets/medias/lecon1/a.mp3');
    await player.play();
  }
  Future p2() async {
    stopplay();
    await player.setAsset('assets/medias/lecon1/sa.mp3');
    await player.play();
  }

  Future p3() async {
    stopplay();
    await player.setAsset('assets/medias/lecon1/ra.mp3');
    await player.play();
  }
  Future p4() async {
    stopplay();
    await player.setAsset('assets/medias/lecon1/i.mp3');
    await player.play();
  }
  Future p5() async {
    stopplay();
    await player.setAsset('assets/medias/lecon1/ri.mp3');
    await player.play();
  }
  Future p6() async {
    stopplay();
    await player.setAsset('assets/medias/lecon1/ras.mp3');
    await player.play();
  }
    ...
    showDialog(
      ...
      builder: (BuildContext context)
      {
        ...
        return AlertDialog(
          ...
          content: Text(' Lisez les cases de la Leçon 1. «rira» commence par «ri». Lisez «ri». «rira» se décompose en deux syllabes «ri» et «ra»', style:TextStyle(color:  Colors.black54), ),
          ...
          children: <Widget>[
            ...
            IconButton(icon: Icon(Icons.arrow_forward_ios), onPressed: () {
             /// if(_radioValue1==0 && _radioValue2==2){
                setState(() {
                  Navigator.of(context).pushNamed('/page4lc1');
                 /* Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) =>
                            ...
                            children: <Widget>[
                                              ...
                                              Container(
                                                ...
                                                new Row(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      Text("sa", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 17.0),),
                                                      ]
                                                ),),
                                              //photo
                                              //icone de son
                                              ...
                                              Container(
                                                ...
                                                new Row(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      Text("ras", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 17.0),),
                                                      ]
                                                ),),
                                              //photo
                                              //icone de son
                              ...
                              Row(
                                ...
                                children: <Widget>[
                                  ...
                                  Text("Divisez les mots suivants en", style: TextStyle(color:Color.fromRGBO(142, 156, 168, 1.0), fontWeight: FontWeight.bold, fontSize:17.0),),
                                  //Question/consigne
                                    ...
                                    Center(
                                        ...
                                        Row(
                                          ...
                                          children: <Widget>[
                                            //Text('Badges:'),
                                            // for (int i = 0; i < 5; i++)
                                            Text("syllabes puis lisez-les.", style: TextStyle(color:Color.fromRGBO(142, 156, 168, 1.0), fontWeight: FontWeight.bold, fontSize:17.0),),
                                          ],
                                        )
                                          ...
                                          Center(
                                              ...
                                              Row(
                                                ...
                                                children: <Widget>[
                                                  //Text('Badges:'),
                                                  // for (int i = 0; i < 5; i++)
                                                  _getExampleBadge(padding: (6).toDouble(),text:"ira"),
                                                 /* new Padding(
                                                    ...
                                                    Container(
                                                      child:new Row(
                                                          ...
                                                          children: <Widget>[
                                                            ...
                                                            _getExampleBadgeElse(padding: (1).toDouble(),text:"i"),
                                                            Text("+", style: TextStyle(color:Color.fromRGBO(142, 156, 168, 1.0), fontWeight: FontWeight.bold),),
                                                            _getExampleBadgeElse(padding: (1).toDouble(),text:"r"),
                                                            Text("+", style: TextStyle(color:Color.fromRGBO(142, 156, 168, 1.0), fontWeight: FontWeight.bold),),
                                                            _getExampleBadgeElse(padding: (1).toDouble(),text:"a"),]
                                                      ),
                                                    ),
                                                    ...
                                                    Container(
                                                      child: new Row(
                                                          ...
                                                          children: <Widget>[
                                                            ...
                                                            _getExampleBadgeElse(padding: (4).toDouble(),text:"ir"),
                                                            Text("+", style: TextStyle(color:Color.fromRGBO(142, 156, 168, 1.0), fontWeight: FontWeight.bold),),
                                          ...
                                          Center(
                                              ...
                                              Row(
                                                ...
                                                children: <Widget>[
                                                  //Text('Badges:'),
                                                  // for (int i = 0; i < 5; i++)
                                                  _getExampleBadge(padding: (6).toDouble(),text:"rira"),
                                                  /*new Padding(
                                                    padding: new EdgeInsets.only(left:5.0),
                                                  ),*/
                                                  _iconDisplay2(),
