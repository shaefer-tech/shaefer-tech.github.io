...
import 'package:exerfrancais/lecon1/l1page7.dart';
...
class _DrawExampleStae extends State<Signature> {
        ...
        child: new Row(
          ...
          children: <Widget>[
            ...
            IconButton(icon: Icon(Icons.arrow_forward_ios), onPressed: () {
              ...
              setState(() {
                Navigator.of(context).pushNamed('/page7lc1');
                /*Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) =>
          ...
          child: Stack(
            children: <Widget>[
              Column(
                children: <Widget>[
                  Center(
                    child: Image.asset("assets/medias/lecon1/draw1.png", fit: BoxFit.cover,),
                  ),
                  Expanded(
                    child: Center(
                      child: AspectRatio(
