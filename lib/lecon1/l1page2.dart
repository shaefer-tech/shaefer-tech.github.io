...
//import 'package:/acceuillumiere.dart';
import 'package:just_audio/just_audio.dart';
import 'package:fluttertoast/fluttertoast.dart';
import 'package:badges/badges.dart';
import 'package:exerfrancais/lecon1/l1page3.dart';
import 'package:awesome_dialog/awesome_dialog.dart';
import 'dart:async';
//import 'package:audioplayers/audioplayers.dart';
class Page2lc1 extends StatefulWidget
{
...
class _Page2State extends State<Page2lc1>
{
  ...
  Future p2() async {
    stopplay();
    await player.setAsset('assets/medias/lecon1/saar.mp3');
    await player.play();
  }

  Future p3() async {
    stopplay();
    await player.setAsset('assets/medias/lecon1/rasa.mp3');
    await player.play();
  }
  Future p4() async {
    stopplay();
    await player.setAsset('assets/medias/lecon1/aari.mp3');
    await player.play();
  }
  Future p5() async {
    stopplay();
    await player.setAsset('assets/medias/lecon1/rira.mp3');
    await player.play();
  }
  Future p6() async {
    stopplay();
    ...
    showDialog(
      ...
      builder: (BuildContext context)
      {
        ...
        return AlertDialog(
          ...
          content:
                Text('Sara peut se décomposer en deux syllabbes «Sa» et «ra». «Sara» commence par «sa». Certaines combinaisons de l\'exercice n\'ont aucun sens en français.', style:TextStyle(color:  Colors.black54),),
          ...
          children: <Widget>[
            ...
            IconButton(icon: Icon(Icons.arrow_forward_ios), onPressed: () {
              //if(_radioValue1==0 && _radioValue2==1){
                setState(() {
                  Navigator.of(context).pushNamed('/page3lc1');
                  /*Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) =>
                                 ...
                                 // color:Color.fromRGBO(239, 243, 246, 1.0),
                                                ...
                                                Container(
                                                  ...
                                                  child:
                                                     new Row(
                                                        ...
                                                        _getExampleBadgeElse(padding: (4).toDouble(),text:"Sara"),]
                                                  ),),
                                    //photo
                                    //icone de son
                                                /*Container(
                                  ...
                                  // mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                               ...
                                               children: <Widget>[
                                                ...
                                                _getExampleBadgeElse(padding: (4).toDouble(),text:"Saar"),]
                                                       ),),
                                    //photo
                                    //icone de son
                                                /* Container(
                                                   ...
                                                   child:
                                                       new Row(
                                                          ...
                                                          new Radio(
                                                           ...
                                                           _getExampleBadgeElse(padding: (4).toDouble(),text:"Rasa"),]
                                                     ),),
                                    //photo
                                    //icone de son
                                                 /*Container(
                                      ...
                                      Center(
                                          ...
                                          Row(
                                            ...
                                            children: <Widget>[
                                              //Text('Badges:'),
                                              // for (int i = 0; i < 5; i++)
                                              _getExampleBadge(padding: (6).toDouble(),text:"ri + ra"),
                                              new Padding(
                                                padding: new EdgeInsets.only(left:10.0),
                                              ),
                                              _iconDisplay2(),
                                         ...
                                         Container(
                                          ...
                                          new Row(
                                              ...
                                              children: <Widget>[
                                                ...
                                                _getExampleBadgeElse(padding: (4).toDouble(),text:"arri"),]
                                          ),),
                                          //photo
                                          //icone de son
                                        ...
                                        Container(
                                          ...
                                          new Row(
                                              ...
                                              children: <Widget>[
                                                ...
                                                _getExampleBadgeElse(padding: (4).toDouble(),text:"aari"),]
                                          ),),
                                          //photo
                                          //icone de son
