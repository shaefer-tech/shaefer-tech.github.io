...
import 'package:exerfrancais/lecon4/l4page7.dart';
import 'package:badges/badges.dart';
import 'package:awesome_dialog/awesome_dialog.dart';

import 'dart:async';
//import 'package:audioplayers/audioplayers.dart';
class Page6lc4 extends StatefulWidget
{
...
class _Page6State extends State<Page6lc4>
{
    ...
    showDialog(
      ...
      builder: (BuildContext context)
      {
        ...
        return AlertDialog(
          ...
          content: Text("Une phrase doit avoir un sens. Une phrase est composée d'un sujet, d'un verbe et d'un complément. Lisez le texte de la Leçon 4.", style:TextStyle(color:  Colors.black54),),
          actions: <Widget>[
            TextButton(
  ...
  Widget build(BuildContext context) {
          ...
          children: <Widget>[
            ...
            IconButton(icon: Icon(Icons.arrow_forward_ios), onPressed: () {
              //if((_radioValue1==1 && _radioValue2==1) && _radioValue3==2){
                setState(() {
                  Navigator.of(context).pushNamed('/page7lc4');
                  /*Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) =>
    ...
    return new Scaffold(
                                          ...
                                          Center(
                                              ...
                                              Row(
                                                ...
                                                children: <Widget>[
                                                  //Text('Badges:'),
                                                  // for (int i = 0; i < 5; i++)
                                                  Text("Un rat ________ la tarte.", style: TextStyle(color:Color.fromRGBO(142, 156, 168, 1.0), fontWeight: FontWeight.bold, fontSize: 17.0),),
                                                ],
                                              )
                                              ...
                                              Container(
                                                ...
                                                new Row(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"menga"),]
                                                ),),
                                              //photo
                                              //icone de son
                                          ...
                                          Center(
                                              ...
                                              Row(
                                                ...
                                                children: <Widget>[
                                                  //Text('Badges:'),
                                                  // for (int i = 0; i < 5; i++)
                                                  Text("Le mari de Sara _______ la rame.", style: TextStyle(color:Color.fromRGBO(142, 156, 168, 1.0), fontWeight: FontWeight.bold, fontSize: 17.0),),
                                                ],
                                              )
                                              ...
                                              Container(
                                                ...
                                                new Row(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"massera"),]
                                                ),),
                                              //photo
                                              //icone de son
                                              ...
                                              Container(
                                                ...
                                                new Row(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"ramasse"),]
                                                ),),
                                              //photo
                                              //icone de son
                                              ...
                                              Container(
                                                ...
                                                new Row(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"seramas"),]
                                                ),),
                                              //photo
                                              //icone de son
                                          ...
                                          Center(
                                              ...
                                              Row(
                                                ...
                                                children: <Widget>[
                                                  //Text('Badges:'),
                                                  // for (int i = 0; i < 5; i++)
                                                  Text("Il y a une rame _________  la mare.", style: TextStyle(color:Color.fromRGBO(142, 156, 168, 1.0), fontWeight: FontWeight.bold, fontSize: 16.0),),
                                                ],
                                              )
                                              ...
                                              Container(
                                                ...
                                                new Row(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"près de"),]
                                                ),),
                                              //photo
                                              //icone de son
                                              ...
                                              Container(
                                                ...
                                                new Row(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"de près"),]
                                                ),),
                                              //photo
                                              //icone de son
                                              ...
                                              Container(
                                                ...
                                                new Row(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"près du"),]
                                                ),),
                                              //photo
                                              //icone de son
      ...
      floatingActionButton: FloatingActionButton(
        ...
        if((_radioValue1==0 && _radioValue2==1) && (_radioValue3==1 && _radioValue4==0)){
          AwesomeDialog(
            context: context,
