...
import 'package:exerfrancais/lecon4/l4page9a.dart';
import 'package:badges/badges.dart';

import '../text_utils.dart';

//import 'package:audioplayers/audioplayers.dart';
class Page8lc4 extends StatefulWidget
{
...
class _Page8State extends State<Page8lc4>
{
  ...
  Future playt1() async {
    stopplay();
    await player.setAsset('assets/medias/lecon4/presdelamarre.mp3');
    await player.play();
  }
  Future playt2() async {
    stopplay();
    await player.setAsset('assets/medias/lecon4/presdelarame.mp3');
    await player.play();
  }
  Future playt3() async {
    stopplay();
    await player.setAsset('assets/medias/lecon4/leratetletas.mp3');
    await player.play();
  }

  Future playtwo() async {
    stopplay();
    await player.setAsset('assets/medias/lecon4/proverbe2V6.mp3');
    await player.play();
  }
        ...
        child: new Row(
          ...
          children: <Widget>[
            ...
            IconButton(icon: Icon(Icons.arrow_forward_ios), onPressed: () {
              ...
              stopplay();
                setState(() {
                  Navigator.of(context).pushNamed('/page9alc4');
                /*  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) =>
                    ...
                    children: <Widget>[
                                  ...
                                  children: <Widget>[
                                    Row(
                                        ...
                                        children: <Widget>[
                                          ...
                                          //Question/consigne
                                          Text("Prenez un stylo", style: TextStyle(color: Color.fromRGBO(142, 156, 168, 1.0), fontWeight: FontWeight.bold, fontSize: 17.0),),
                                          Ink(
                                            width: 20.0,
                                            height: 20.0,
                                            decoration: ShapeDecoration(
                                            ...
                                            child: Center(
                                              child:Icon(Icons.create, color: Color.fromRGBO(142, 156, 168, 1.0),),
                                            ),

                                          ),
                                          Text("et du papier ", style: TextStyle(color: Color.fromRGBO(142, 156, 168, 1.0), fontWeight: FontWeight.bold, fontSize: 17.0),),
                                          Ink(
                                            width: 20.0,
                                            height: 20.0,
                                            decoration: ShapeDecoration(
                                            ...
                                            child: Center(
                                              child:Icon(Icons.assignment, color: Color.fromRGBO(142, 156, 168, 1.0),),
                                            ),
                                    ...
                                    Center(
                                        ...
                                        Row(
                                          ...
                                          children: <Widget>[
                                            //Text('Badges:'),
                                            // for (int i = 0; i < 5; i++)
                                            Text("et complètez les carreaux suivants à ", style: TextStyle(color:Color.fromRGBO(142, 156, 168, 1.0), fontWeight: FontWeight.bold, fontSize: 16.0),),
                                    ...
                                    Center(
                                        ...
                                        Row(
                                          ...
                                          children: <Widget>[
                                            //Text('Badges:'),
                                            // for (int i = 0; i < 5; i++)
                                            Text("à l'aide des images illustrées.", style: TextStyle(color:Color.fromRGBO(142, 156, 168, 1.0), fontWeight: FontWeight.bold, fontSize: 16.0),),
                                            // Text("Puis validez.", style: TextStyle(color:Color.fromRGBO(142, 156, 168, 1.0), fontWeight: FontWeight.bold),),
                                          ],
                                        )
                                    ...
                                    Center(
                                      child:
                                      Image.asset("assets/medias/lecon4/motCrois4Coul.png", fit: BoxFit.cover,),
                                ...
                                Container(
                                  ...
                                  new Row(
                                      ...
                                      children: <Widget>[
                                        ...
                                        _getExampleBadgeElse(padding: (4).toDouble(),text:"près de la mare."),]
                                  ),),
                                //photo
                                //icone de son
                                ...
                                Container(
                                  ...
                                  new Row(
                                      ...
                                      children: <Widget>[
                                        ...
                                        _getExampleBadgeElse(padding: (4).toDouble(),text:"près de la rame."),]
                                  ),),
                                //photo
                                //icone de son
                                /*Container(
                                ...
                                Container(
                                  ...
                                  new Row(
                                      ...
                                      children: <Widget>[
                                        ...
                                        _getExampleBadgeElse(padding: (4).toDouble(),text:"Le rat  et le tas."),
                                        new Padding(
                                          padding: new EdgeInsets.only(left:5.0),
                                        ),]
                                  ),),
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          ...
                          Text("Ecoutez le verset suivant.", style: TextStyle(color:Color.fromRGBO(142, 156, 168, 1.0), fontWeight: FontWeight.bold, fontSize: 17.0),),
                          //Question/consigne
                            ...
                            children: <Widget>[
                              ...
                              Center(
                                  ...
                                  Row(
                                    mainAxisAlignment: MainAxisAlignment.center,
                                    children: <Widget>[
                                      _getExampleBadge(padding: (6).toDouble(),text:"Prov. 2 V.6-7"),
                                    ],
                                  )
                              ...
                              Center(
                                  ...
                                  Row(
                                    ...
                                    children: <Widget>[
                                      //Text('Badges:'),
                                      // for (int i = 0; i < 5; i++)
                                      Text("ra", style: TextStyle(color:Color.fromRGBO(142, 156, 168, 1.0), fontWeight: FontWeight.bold),),
                                     // Text("Puis validez.", style: TextStyle(color:Color.fromRGBO(142, 156, 168, 1.0), fontWeight: FontWeight.bold),),
                                    ],
                                  )
                              ...
                              Center(
                                  ...
                                  Row(
                                    ...
                                    children: <Widget>[
                                      //Text('Badges:'),
                                      // for (int i = 0; i < 5; i++)
                                      Text("ma", style: TextStyle(color:Color.fromRGBO(142, 156, 168, 1.0), fontWeight: FontWeight.bold),),
                                      // Text("Puis validez.", style: TextStyle(color:Color.fromRGBO(142, 156, 168, 1.0), fontWeight: FontWeight.bold),),
                                    ],
                                  )
