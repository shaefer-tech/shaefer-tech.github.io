...
import 'package:exerfrancais/lecon4/l4pageRappel.dart';
...
class Page2lc4 extends StatefulWidget
{
...
class _Page2State extends State<Page2lc4>
{
  ...
  Future p1() async {
    stopplay();
    await player.setAsset('assets/medias/lecon4/rema.mp3');
    await player.play();
  }
  Future p2() async {
    stopplay();
  ...
  Future p7() async {
    stopplay();
    await player.setAsset('assets/medias/lecon4/masse.mp3');
    await player.play();
  }
  Future p8() async {
    stopplay();
    await player.setAsset('assets/medias/lecon4/semas.mp3');
    await player.play();
  }
  Future p9() async {
    stopplay();
    await player.setAsset('assets/medias/lecon4/essam.mp3');
    await player.play();
  }
      ...
      builder: (BuildContext context)
      {
        ...
        return AlertDialog(
          ...
          content:
              ...
              Text('«mare» peut se décomposer en deux syllabbes:  «ma» et  «re».  «mare» commence par  «ma» et le  «e»  final ne se prononce pas. Certaines  combinaisons le l\'exercice n\'ont aucun sens en français.',  style:TextStyle(color:  Colors.black54),),
  ...
  Widget build(BuildContext context) {
          ...
          children: <Widget>[
            ...
            IconButton(icon: Icon(Icons.arrow_forward_ios), onPressed: () {
              //if((_radioValue1==0 && _radioValue2==1)){
                setState(() {
                  Navigator.of(context).pushNamed('/pageRappelc4');
                 /* Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) =>
    ...
    return new Scaffold(
                                 ...
                                 // color:Color.fromRGBO(239, 243, 246, 1.0),
                                  child:Column(
                                    children: <Widget>[
                                        ...
                                        //Text('Badges:'),
                                       // for (int i = 0; i < 5; i++)
                                                     _getExampleBadge(padding: (6).toDouble(),text:"ma + re"),
                                                   new Padding(
                                                ...
                                                Container(
                                                  ...
                                                  child:
                                                     new Row(
                                                        ...
                                                        _getExampleBadgeElse(padding: (4).toDouble(),text:"rema"),]
                                                  ),),
                                    //photo
                                    //icone de son
                                               /* Container(
                                  ...
                                  // mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                               ...
                                               children: <Widget>[
                                                ...
                                                _getExampleBadgeElse(padding: (4).toDouble(),text:"mare"),]
                                                       ),),
                                    //photo
                                    //icone de son
                                                /* Container(
                                                   ...
                                                   child:
                                                       new Row(
                                                          ...
                                                          new Radio(
                                                           ...
                                                           _getExampleBadgeElse(padding: (4).toDouble(),text:"rame"),]
                                                     ),),
                                    //photo
                                    //icone de son
                                               /*  Container(
                                      ...
                                      Center(
                                          ...
                                          Row(
                                            ...
                                            children: <Widget>[
                                              //Text('Badges:'),
                                              // for (int i = 0; i < 5; i++)
                                              _getExampleBadge(padding: (6).toDouble(),text:"ra + me"),
                                              new Padding(
                                                padding: new EdgeInsets.only(left:8.0),
                                              ),
                                              _iconDisplay2(),
                                      ...
                                      Center(
                                          ...
                                          Row(
                                            ...
                                            children: <Widget>[
                                              //Text('Badges:'),
                                              // for (int i = 0; i < 5; i++)
                                              _getExampleBadge(padding: (6).toDouble(),text:"mas + se"),
                                              new Padding(
                                                padding: new EdgeInsets.only(left:8.0),
                                              ),
                                              _iconDisplay3(),
                                          ...
                                          Container(
                                            ...
                                            new Row(
                                                ...
                                                children: <Widget>[
                                                  ...
                                                  _getExampleBadgeElse(padding: (4).toDouble(),text:"masse"),]
                                            ),),
                                          //photo
                                          //icone de son
                                          ...
                                          Container(
                                            ...
                                            new Row(
                                                ...
                                                children: <Widget>[
                                                  ...
                                                  _getExampleBadgeElse(padding: (4).toDouble(),text:"semas"),]
                                            ),),
                                          //photo
                                          //icone de son
                                          /*Container(
                                          ...
                                          Container(
                                            ...
                                            new Row(
                                                ...
                                                children: <Widget>[
                                                  ...
                                                  _getExampleBadgeElse(padding: (4).toDouble(),text:"essam"),]
                                            ),),
                                          //photo
                                          //icone de son
      ...
      floatingActionButton: FloatingActionButton(
        ...
        if((_radioValue1==1 && _radioValue2==2) &&(_radioValue3== 0)){
