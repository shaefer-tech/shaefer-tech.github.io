...
import 'package:exerfrancais/lecon4/l4page4.dart';
...
class Page3lc4 extends StatefulWidget
{
...
class _Page3State extends State<Page3lc4>
{
  ...
  _iconDisplay2(){
    if(_radioValue2 != -1) {
      //bool readStatus = _notes[index].getReadState;
      return Icon(((_radioValue2  == 0) ? Icons.check_circle : Icons
          .cancel),
        color: (_radioValue2 == 0) ? Colors.green : Colors.red,);
    }
    ...
    showDialog(
      ...
      builder: (BuildContext context)
      {
        ...
        return AlertDialog(
          ...
          content:
            Text('Lisez les cases de la Leçon 4. «ramasse» commence par «ra» et se termine par «se». «Ramasse» est composé de trois syllabes: «ra», «mas» et «se».',   style:TextStyle(color:  Colors.black54),),
  ...
  Widget build(BuildContext context) {
          ...
          children: <Widget>[
            ...
            IconButton(icon: Icon(Icons.arrow_forward_ios), onPressed: () {
              //if((_radioValue1==0 && _radioValue2==1) && (_radioValue3==2 && _radioValue4==2)){
                setState(() {
                  Navigator.of(context).pushNamed('/page4lc4');
                  /*Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) =>
    ...
    return new Scaffold(
                                          ...
                                          Center(
                                              ...
                                              Row(
                                                ...
                                                children: <Widget>[
                                                  //Text('Badges:'),
                                                  // for (int i = 0; i < 5; i++)
                                                  _getExampleBadge(padding: (6).toDouble(),text:"imite"),
                                                  new Padding(
                                              ...
                                              Container(
                                                ...
                                                new Row(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"i"),
                                                      ...
                                                      Text("+", style: TextStyle(color:Color.fromRGBO(142, 156, 168, 1.0), fontWeight: FontWeight.bold),),
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"te"),
                                                    ]
                                                ),),
                                              //photo
                                              //icone de son
                                          ...
                                          Center(
                                              ...
                                              Row(
                                                ...
                                                children: <Widget>[
                                                  //Text('Badges:'),
                                                  // for (int i = 0; i < 5; i++)
                                                  _getExampleBadge(padding: (6).toDouble(),text:"masse"),
                                                  new Padding(
                                                    padding: new EdgeInsets.only(left:8.0),
                                                  ),
                                                  _iconDisplay2(),
                                              ...
                                              Container(
                                                ...
                                                new Row(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"mass"),
                                                      Text("+", style: TextStyle(color:Color.fromRGBO(142, 156, 168, 1.0), fontWeight: FontWeight.bold),),
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"e"),]
                                              ...
                                              Container(
                                                ...
                                                new Row(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      Text("+", style: TextStyle(color:Color.fromRGBO(142, 156, 168, 1.0), fontWeight: FontWeight.bold),),
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"sse"),]
                                                ),),
                                              //photo
                                              //icone de son
                                          ...
                                          Center(
                                              ...
                                              Row(
                                                ...
                                                children: <Widget>[
                                                  //Text('Badges:'),
                                                  // for (int i = 0; i < 5; i++)
                                                  _getExampleBadge(padding: (6).toDouble(),text:"mari"),
                                                  new Padding(
                                                    padding: new EdgeInsets.only(left:8.0),
                                                  ),
                                                  _iconDisplay3(),
                                              ...
                                              Container(
                                                ...
                                                new Row(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"ri"),
                                                      Text("+", style: TextStyle(color:Color.fromRGBO(142, 156, 168, 1.0), fontWeight: FontWeight.bold),),
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"ma"),
                                                    ]
                                                ),),
                                          ...
                                          Center(
                                              ...
                                              Row(
                                                ...
                                                children: <Widget>[
                                                  //Text('Badges:'),
                                                  // for (int i = 0; i < 5; i++)
                                                  _getExampleBadge(padding: (6).toDouble(),text:"rame"),
                                                  new Padding(
                                                    padding: new EdgeInsets.only(left:8.0),
                                                  ),
                                                  _iconDisplay4(),
                                              ...
                                              Container(
                                                ...
                                                new Row(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"ra"),
                                                      Text("+", style: TextStyle(color:Color.fromRGBO(142, 156, 168, 1.0), fontWeight: FontWeight.bold),),
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"me"),
                                                    ]
                                                ),),
                                              //photo
                                              //icone de son
                                              ...
                                              Container(
                                                ...
                                                new Row(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"r"),
                                                      Text("+", style: TextStyle(color:Color.fromRGBO(142, 156, 168, 1.0), fontWeight: FontWeight.bold),),
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"ame"),
                                                    ]
                                                ),),
                                              //photo
                                              //icone de son
      ...
      floatingActionButton: FloatingActionButton(
        ...
        if(((_radioValue1==0 && _radioValue2==0)&& _radioValue3==1) && (_radioValue4==0 && _radioValue5==0)){
          AwesomeDialog(
            context: context,
