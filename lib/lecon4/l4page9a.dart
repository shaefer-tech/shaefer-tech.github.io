...
import 'package:exerfrancais/lecon4/l4page10.dart';
...
class Signaturelc4 extends StatefulWidget {
...
class _DrawExampleStae extends State<Signaturelc4> {
        ...
        child: new Row(
          ...
          children: <Widget>[
            ...
            IconButton(icon: Icon(Icons.arrow_forward_ios), onPressed: () {
              ...
              setState(() {
                Navigator.of(context).pushNamed('/page10lc4');
               /* Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) =>
          ...
          child: Stack(
            children: <Widget>[
              Column(
                children: <Widget>[
                  Center(
                    child: Image.asset("assets/medias/lecon4/draw4.png", fit: BoxFit.cover,),
                  ),
                  Expanded(
                    child: Center(
                      child: AspectRatio(
