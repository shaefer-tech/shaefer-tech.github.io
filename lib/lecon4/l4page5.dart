...
import 'package:exerfrancais/lecon4/l4page6.dart';
import 'package:awesome_dialog/awesome_dialog.dart';

import 'package:badges/badges.dart';
import 'dart:async';
//import 'package:audioplayers/audioplayers.dart';
class Page5lc4 extends StatefulWidget
{
...
class _Page5State extends State<Page5lc4>
{
          ...
          children: <Widget>[
            ...
            IconButton(icon: Icon(Icons.arrow_forward_ios), onPressed: () {
             // if(_radioValue1==0 && _radioValue2==2) {
                setState(() {
                  Navigator.of(context).pushNamed('/page6lc4');
                 /* Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) =>
