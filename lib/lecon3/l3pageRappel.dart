...
import 'package:exerfrancais/lecon3/l3page3.dart';
import 'package:awesome_dialog/awesome_dialog.dart';
import 'dart:async';

import 'package:just_audio/just_audio.dart';
//import 'package:audioplayers/audioplayers.dart';
class PageRapelc3 extends StatefulWidget
{
...
class _PageRState extends State<PageRapelc3>
{
  ...
  Future p1() async {
    stopplay();
    await player.setAsset('assets/medias/lecon3/a.mp3');
    await player.play();
  }
  Future p2() async {
    stopplay();
    await player.setAsset('assets/medias/lecon3/ta.mp3');
    await player.play();
  }

  Future p3() async {
    stopplay();
    await player.setAsset('assets/medias/lecon3/tar.mp3');
    await player.play();
  }
  Future p4() async {
    stopplay();
  ...
  Future p7() async {
    stopplay();
    await player.setAsset('assets/medias/lecon3/i.mp3');
    await player.play();
  }
  Future p8() async {
    stopplay();
    await player.setAsset('assets/medias/lecon3/il.mp3');
  }
  Future p9() async {
    stopplay();
    await player.setAsset('assets/medias/lecon3/i.mp3');
    ...
    showDialog(
      ...
      builder: (BuildContext context)
      {
        ...
        return AlertDialog(
          ...
          content: Text("Lisez les cases de la Leçon 3. La syllabe est un fractionnement du mot parlé pour analyser de ses constituants.", style:TextStyle(color:  Colors.black54),),
          actions: <Widget>[
            FlatButton(
        ...
        child: new Row(
          ...
          children: <Widget>[
            ...
            IconButton(icon: Icon(Icons.arrow_forward_ios), onPressed: () {
              ...
              setState(() {
                Navigator.of(context).pushNamed('/page3lc3');
                /*Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) =>
                                              ...
                                              Container(
                                                ...
                                                new Row(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      Text("tar", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 17.0),),
                                              ...
                                              Container(
                                                ...
                                                new Row(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      Text("rat", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 17.0),),
                                                      ]
                                                ),),
                                              //photo
                                              //icone de son
                                              ...
                                              Container(
                                                ...
                                                new Row(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      Text("tas", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 17.0),),
                                                      ]
                                                ),),
                                              //photo
                                              //icone de son
                                              ...
                                              Container(
                                                ...
                                                new Row(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      Text("Il", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 17.0),),
                                                      ]
                                                ),),
                                              //photo
                                              //icone de son
