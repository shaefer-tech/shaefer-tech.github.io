...
import 'package:exerfrancais/lecon3/l3page10.dart';
...
class Signaturelc3 extends StatefulWidget {
...
class _DrawExampleStae extends State<Signaturelc3> {
        ...
        child: new Row(
          ...
          children: <Widget>[
            ...
            IconButton(icon: Icon(Icons.arrow_forward_ios), onPressed: () {
              ...
              setState(() {
                Navigator.of(context).pushNamed('/page10lc3');
               /* Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) =>
          ...
          child: Stack(
            children: <Widget>[
              Column(
                children: <Widget>[
                  Center(
                    child: Image.asset("assets/medias/lecon3/draw3.png", fit: BoxFit.cover,),
                  ),
                  Expanded(
                    child: Center(
                      child: AspectRatio(
