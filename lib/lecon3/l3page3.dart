...
import 'package:exerfrancais/lecon3/l3page4.dart';
import 'package:awesome_dialog/awesome_dialog.dart';

import 'dart:async';
//import 'package:audioplayers/audioplayers.dart';
class Page3lc3 extends StatefulWidget
{
...
class _Page3State extends State<Page3lc3>
{
  ...
  _iconDisplay4(){
    if(_radioValue4 != -1) {
      //bool readStatus = _notes[index].getReadState;
      return Icon(((_radioValue4  == 2) ? Icons.check_circle : Icons
          .cancel),
        color: (_radioValue4 == 2) ? Colors.green : Colors.red,);
    }
    ...
    showDialog(
      ...
      builder: (BuildContext context)
      {
        ...
        return AlertDialog(
          ...
          content:
              Text('Lisez les cases de la Leçon 3. «ratisse» commence par «ra» et se termine par «se». «Ratisse» est composé de trois syllabes: «ra», «tis» et «se» ',style:TextStyle(color:  Colors.black54),),
          ...
          children: <Widget>[
            ...
            IconButton(icon: Icon(Icons.arrow_forward_ios), onPressed: () {
              //if((_radioValue1==0 && _radioValue2==1) && (_radioValue3==2 && _radioValue4==2)){
                setState(() {
                  Navigator.of(context).pushNamed('/page4lc3');
                  /*Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) =>
                                          ...
                                          Center(
                                              ...
                                              Row(
                                                ...
                                                children: <Widget>[
                                                  //Text('Badges:'),
                                                  // for (int i = 0; i < 5; i++)
                                                  _getExampleBadge(padding: (6).toDouble(),text:"ratisse"),
                                                  new Padding(
                                              ...
                                              Container(
                                                ...
                                                new Row(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"tis"),
                                                      Text("+", style: TextStyle(color:Color.fromRGBO(142, 156, 168, 1.0), fontWeight: FontWeight.bold),),
                                              ...
                                              Container(
                                                ...
                                                new Row(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"rat"),
                                                      Text("+", style: TextStyle(color:Color.fromRGBO(142, 156, 168, 1.0), fontWeight: FontWeight.bold),),
                                          ...
                                          Row(
                                            ...
                                            children: <Widget>[
                                              Container(
                                                ...
                                                _getExampleBadgeElse(padding: (4).toDouble(),text:"ra"),
                                                      Text("+", style: TextStyle(color:Color.fromRGBO(142, 156, 168, 1.0), fontWeight: FontWeight.bold),),
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"ti"),]
                                                ),),
                                              //photo
                                              //icone de son
                                          ...
                                          Center(
                                              ...
                                              Row(
                                                ...
                                                children: <Widget>[
                                                  //Text('Badges:'),
                                                  // for (int i = 0; i < 5; i++)
                                                  _getExampleBadge(padding: (6).toDouble(),text:"tisse"),
                                                  new Padding(
                                                    padding: new EdgeInsets.only(left:8.0),
                                                  ),
                                                  _iconDisplay2(),
                                          ...
                                          Center(
                                              ...
                                              Row(
                                                ...
                                                children: <Widget>[
                                                  //Text('Badges:'),
                                                  // for (int i = 0; i < 5; i++)
                                                  _getExampleBadge(padding: (6).toDouble(),text:"tas"),
                                                  new Padding(
                                                    padding: new EdgeInsets.only(left:8.0),
                                                  ),
                                                  _iconDisplay3(),
                                              ...
                                              Container(
                                                ...
                                                new Row(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"t"),
                                                      Text("+", style: TextStyle(color:Color.fromRGBO(142, 156, 168, 1.0), fontWeight: FontWeight.bold),),
                                              ...
                                              Container(
                                                ...
                                                new Row(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"ta"),
                                                      Text("+", style: TextStyle(color:Color.fromRGBO(142, 156, 168, 1.0), fontWeight: FontWeight.bold),),
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"s"),
                                                      ]
                                                ),),
                                              //photo
                                              //icone de son
                                              ...
                                              Container(
                                                ...
                                                new Row(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"tas"),
                                                     ]
                                                ),),
                                              //photo
                                              //icone de son
                                          ...
                                          Center(
                                              ...
                                              Row(
                                                ...
                                                children: <Widget>[
                                                  //Text('Badges:'),
                                                  // for (int i = 0; i < 5; i++)
                                                  _getExampleBadge(padding: (6).toDouble(),text:"rat"),
                                                  new Padding(
                                                    padding: new EdgeInsets.only(left:8.0),
                                                  ),
                                                  _iconDisplay4(),
                                              ...
                                              Container(
                                                ...
                                                new Row(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      Text("+", style: TextStyle(color:Color.fromRGBO(142, 156, 168, 1.0), fontWeight: FontWeight.bold),),
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"at"),
                                                    ]
                                                ),),
                                              //photo
                                              //icone de son
