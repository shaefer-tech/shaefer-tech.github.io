...
import 'package:exerfrancais/lecon3/l3page2.dart';
...
class Page1lc3 extends StatefulWidget
{
...
class _Page1State extends State<Page1lc3>
{
  ...
  _iconDisplay(){
    if(isRightRira) {
      ...
      return Icon(((isRightRira && vrai == 1) ? Icons.check_circle : Icons
          .cancel),
        color: (isRightRira && vrai == 1) ? Colors.green : Colors.red,);
    }
    else{
  ...
  Future p1() async {
    stopplay();
    await player.setAsset('assets/medias/lecon3/ra.mp3');
    await player.play();
  }
  Future p2() async {
    stopplay();
    ...
    showDialog(
      ...
      builder: (BuildContext context)
      {
        ...
        return AlertDialog(
          ...
          content: Text("Lisez la page 36 du Syllabaire. La première image représente un «rat». Le rat est un petit animal qui aime manger la nourriture qui traine dans la maison.", style:TextStyle(color:  Colors.black54),),
          actions: <Widget>[
            TextButton(
          ...
          children: <Widget>[
            ...
            IconButton(icon: Icon(Icons.arrow_forward_ios), onPressed: () {
             // if(isRightRira && vrai==1){
                setState(() {
                  Navigator.of(context).pushNamed('/page2lc3');
                 /* Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) =>
                                  ...
                                  children: <Widget>[
                                    Card(
                                      ...
                                      child: new Container(
                                          height: hautimg,
                                          width: largimg,
                                          child: Image.asset("assets/medias/lecon3/ratCoul.png")
                                      ),
                                    ...
                                    Ink(
                                      ...
                                      child:  Text("rat", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 16.0),),
                                    ),
                                    /// nom image
                                    //icone de son
                                    Ink(
                                  ...
                                  children: <Widget>[
                                    Card(
                                      ...
                                      child: new Container(
                                          height: hautimg,
                                          width: largimg,
                                          child: Image.asset("assets/medias/lecon3/tarteCoul.png")
                                      ),
                                    ...
                                    Ink(
                                      ...
                                      child:  Text("tarte", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 16.0),),
                                    ),
                                    /// nom image
                                    //icone de son
                                    Ink(
                        ...
                        children: <Widget>[
                          ...
                          Card(
                            ...
                            child: new Container(
                                height: hautimg,
                                width: largimg,
                                child: Image.asset("assets/lecon3/tarteCoul.png")
                            ),
                            ...
                            children: <Widget>[
                              ConstrainedBox(
                                ...
                                child:ElevatedButton(
                                  ...
                                  child: TextUtils("rat  ", color:Color.fromRGBO(142, 156, 168, 1.0),fontSize: 16.0),
                                  onPressed:(){
                                    setState(() {
                            ...
                            children: <Widget>[
                              ConstrainedBox(
                                ...
                                child:ElevatedButton(
                                  ...
                                  child: TextUtils("tar  ", color:Color.fromRGBO(142, 156, 168, 1.0),fontSize: 16.0),
                                  onPressed:(){
                                    setState(() {
                                      isRightElleRira=true;
                                      isRightEllerit=true;
                              ...
                              ConstrainedBox(
                                ...
                                child:ElevatedButton(
                                  ...
                                  child: TextUtils("tasse ", color:Color.fromRGBO(142, 156, 168, 1.0),fontSize: 16.0),
                                  onPressed:(){
                                    setState(() {
                                      isRightElleRira=true;
                                      isRightEllerit=true;
