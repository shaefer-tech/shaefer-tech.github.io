...
import 'package:exerfrancais/lecon3/l3page6.dart';
...
class Page5lc3 extends StatefulWidget
{
...
class _Page5State extends State<Page5lc3>
{
  ...
  Widget build(BuildContext context) {
          ...
          children: <Widget>[
            ...
            IconButton(icon: Icon(Icons.arrow_forward_ios), onPressed: () {
             // if(_radioValue1==0 && _radioValue2==2) {
                setState(() {
                  Navigator.of(context).pushNamed('/page6lc3');
                 /* Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) =>
    ...
    return new Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        if((_radioValue1==0 && _radioValue2==2) && (_radioValue3==2)) {
          AwesomeDialog(
            context: context,
