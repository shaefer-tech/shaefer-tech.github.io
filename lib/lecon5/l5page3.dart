...
import 'package:exerfrancais/lecon5/l5page4.dart';
import 'package:awesome_dialog/awesome_dialog.dart';

import 'dart:async';
//import 'package:audioplayers/audioplayers.dart';
class Page3lc5 extends StatefulWidget
{
...
class _Page3State extends State<Page3lc5>
{
  ...
  _iconDisplay3(){
    if(_radioValue3 != -1) {
      //bool readStatus = _notes[index].getReadState;
      return Icon(((_radioValue3  == 1) ? Icons.check_circle : Icons
          .cancel),
        color: (_radioValue3 == 1) ? Colors.green : Colors.red,);
    }
  ...
  _iconDisplay5(){
    if(_radioValue5 != -1) {
      //bool readStatus = _notes[index].getReadState;
      return Icon(((_radioValue5  == 0) ? Icons.check_circle : Icons
          .cancel),
        color: (_radioValue5 == 0) ? Colors.green : Colors.red,);
    }
    else if(_radioValue5 == -1){
    ...
    showDialog(
      ...
      builder: (BuildContext context)
      {
        ...
        return AlertDialog(
          ...
          content:
             Text('Lisez les cases de la Leçon 5. «admire» commence par «ad» et se termine par  «re». «Admire» est composé de trois syllabes «ad», «mi» et «re».', style:TextStyle(color:  Colors.black54),),
  ...
  Widget build(BuildContext context) {
        ...
        child: new Row(
          ...
          children: <Widget>[
            ...
            IconButton(icon: Icon(Icons.arrow_forward_ios), onPressed: () {
              //if((_radioValue1==0 && _radioValue2==1) && (_radioValue3==2 && _radioValue4==2)){
                setState(() {
                  Navigator.of(context).pushNamed('/page4lc5');
                  /*Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) =>
    ...
    return new Scaffold(
                            ...
                            children: <Widget>[
                              Row(
                                ...
                                children: <Widget>[
                                  ...
                                  Icon(Icons.looks_4, color:Color.fromRGBO(38, 153, 251, 1.0), size: 40.0),
                                  Text("Divisez les mots suivants en syllabes", style: TextStyle(color:Color.fromRGBO(142, 156, 168, 1.0), fontWeight: FontWeight.bold, fontSize:17.0),),
                                  //Question/consigne
                                    ...
                                    Center(
                                        ...
                                        Row(
                                          ...
                                          children: <Widget>[
                                            //Text('Badges:'),
                                            // for (int i = 0; i < 5; i++)
                                            Text("puis lisez-les.", style: TextStyle(color:Color.fromRGBO(142, 156, 168, 1.0), fontWeight: FontWeight.bold, fontSize:17.0),),
                                          ],
                                        )
                                          ...
                                          Center(
                                              ...
                                              Row(
                                                ...
                                                children: <Widget>[
                                                  //Text('Badges:'),
                                                  // for (int i = 0; i < 5; i++)
                                                  _getExampleBadge(padding: (6).toDouble(),text:"radis"),
                                                  new Padding(
                                              ...
                                              Container(
                                                ...
                                                new Row(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"ra"),
                                                      Text("+", style: TextStyle(color:Color.fromRGBO(142, 156, 168, 1.0), fontWeight: FontWeight.bold),),
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"dis"),
                                              ...
                                              Container(
                                                ...
                                                new Row(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"rad"),
                                                      Text("+", style: TextStyle(color:Color.fromRGBO(142, 156, 168, 1.0), fontWeight: FontWeight.bold),),
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"is"),
                                                  ]
                                                ),),
                                              //photo
                                              //icone de son
                                          ...
                                          Row(
                                            ...
                                            children: <Widget>[
                                              Container(
                                                ...
                                                _getExampleBadgeElse(padding: (4).toDouble(),text:"di"),
                                                Text("+", style: TextStyle(color:Color.fromRGBO(142, 156, 168, 1.0), fontWeight: FontWeight.bold),),
                                                _getExampleBadgeElse(padding: (4).toDouble(),text:"ras"),
                                                    ]
                                                ),),
                                              //photo
                                              //icone de son
                                          ...
                                          Center(
                                              ...
                                              Row(
                                                ...
                                                children: <Widget>[
                                                  //Text('Badges:'),
                                                  // for (int i = 0; i < 5; i++)
                                                  _getExampleBadge(padding: (6).toDouble(),text:"mardi"),
                                                  new Padding(
                                                    padding: new EdgeInsets.only(left:8.0),
                                                  ),
                                                  _iconDisplay2(),
                                              ...
                                              Container(
                                                ...
                                                new Row(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"di"),
                                                      Text("+", style: TextStyle(color:Color.fromRGBO(142, 156, 168, 1.0), fontWeight: FontWeight.bold),),
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"mar"),
                                                     ]
                                                ),),
                                              //photo
                                              //icone de son
                                              ...
                                              Container(
                                                ...
                                                new Row(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"ma"),
                                                      Text("+", style: TextStyle(color:Color.fromRGBO(142, 156, 168, 1.0), fontWeight: FontWeight.bold),),
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"rdi"),]
                                          ...
                                          Center(
                                              ...
                                              Row(
                                                ...
                                                children: <Widget>[
                                                  //Text('Badges:'),
                                                  // for (int i = 0; i < 5; i++)
                                                  _getExampleBadge(padding: (6).toDouble(),text:"dattes"),
                                                  new Padding(
                                                    padding: new EdgeInsets.only(left:8.0),
                                                  ),
                                                  _iconDisplay3(),
                                              ...
                                              Container(
                                                ...
                                                new Row(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"da"),
                                                      Text("+", style: TextStyle(color:Color.fromRGBO(142, 156, 168, 1.0), fontWeight: FontWeight.bold),),
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"ttes"),
                                                    ]
                                                ),),
                                              //photo
                                              //icone de son
                                              ...
                                              Container(
                                                ...
                                                new Row(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"dat"),
                                                      Text("+", style: TextStyle(color:Color.fromRGBO(142, 156, 168, 1.0), fontWeight: FontWeight.bold),),
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"tes"),
                                                      ]
                                                ),),
                                              //photo
                                              //icone de son
                                              ...
                                              Container(
                                                ...
                                                new Row(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"datt"),
                                                      Text("+", style: TextStyle(color:Color.fromRGBO(142, 156, 168, 1.0), fontWeight: FontWeight.bold),),
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"es"),
                                                     ]
                                                ),),
                                              //photo
                                              //icone de son
                                          ...
                                          Center(
                                              ...
                                              Row(
                                                ...
                                                children: <Widget>[
                                                  //Text('Badges:'),
                                                  // for (int i = 0; i < 5; i++)
                                                  _getExampleBadge(padding: (6).toDouble(),text:"admire"),
                                                  new Padding(
                                                    padding: new EdgeInsets.only(left:8.0),
                                                  ),
                                                  _iconDisplay4(),
                                              ...
                                              Container(
                                                ...
                                                new Row(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"ad"),
                                                      Text("+", style: TextStyle(color:Color.fromRGBO(142, 156, 168, 1.0), fontWeight: FontWeight.bold),),
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"mi"),
                                                      Text("+", style: TextStyle(color:Color.fromRGBO(142, 156, 168, 1.0), fontWeight: FontWeight.bold),),
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"re"),
                                                    ]
                                                ),),
                                              //photo
                                              //icone de son
                                          ...
                                          Center(
                                              ...
                                              Row(
                                                ...
                                                children: <Widget>[
                                                  //Text('Badges:'),
                                                  // for (int i = 0; i < 5; i++)
                                                  _getExampleBadge(padding: (6).toDouble(),text:"ramasse"),
                                                  new Padding(
                                                    padding: new EdgeInsets.only(left:8.0),
                                                  ),
                                                  _iconDisplay5(),
                                              ...
                                              Container(
                                                ...
                                                new Row(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"ra"),
                                                      Text("+", style: TextStyle(color:Color.fromRGBO(142, 156, 168, 1.0), fontWeight: FontWeight.bold),),
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"mas"),
                                                      Text("+", style: TextStyle(color:Color.fromRGBO(142, 156, 168, 1.0), fontWeight: FontWeight.bold),),
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"se"),
                                                    ]
                                                ),),
                                              //photo
                                              //icone de son
                                              ...
                                              Container(
                                                ...
                                                new Row(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"ram"),
                                                      Text("+", style: TextStyle(color:Color.fromRGBO(142, 156, 168, 1.0), fontWeight: FontWeight.bold),),
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"as"),
                                                      Text("+", style: TextStyle(color:Color.fromRGBO(142, 156, 168, 1.0), fontWeight: FontWeight.bold),),
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"se"),
                                                    ]
                                                ),),
      ...
      floatingActionButton: FloatingActionButton(
        ...
        if((_radioValue1==0 && _radioValue2==2)&&(_radioValue3==1 && _radioValue4==0)){
          AwesomeDialog(
            context: context,
