...
import 'package:exerfrancais/lecon5/l5pageRappel.dart';
...
class Page2lc5 extends StatefulWidget
{
...
class _Page2State extends State<Page2lc5>
{

  _iconDisplay1(){
    if(_radioValue1 != -1) {
      //bool readStatus = _notes[index].getReadState;
      return Icon(((_radioValue1 == 1) ? Icons.check_circle : Icons
          .cancel),
        color: (_radioValue1 ==1) ? Colors.green : Colors.red,);
    }
  ...
  _iconDisplay3(){
    if(_radioValue3 != -1) {
      //bool readStatus = _notes[index].getReadState;
      return Icon(((_radioValue3  == 2) ? Icons.check_circle : Icons
          .cancel),
        color: (_radioValue3 == 2) ? Colors.green : Colors.red,);
    }
  ...
  _iconDisplay4(){
    if(_radioValue4 != -1) {
      //bool readStatus = _notes[index].getReadState;
      return Icon(((_radioValue4  == 1) ? Icons.check_circle : Icons
          .cancel),
        color: (_radioValue4 == 1) ? Colors.green : Colors.red,);
    }
  ...
  Future p1() async {
    stopplay();
    await player.setAsset('assets/medias/lecon5/disra.mp3');
    await player.play();
  }
  Future p2() async {
    stopplay();
  ...
  Future p3() async {
    stopplay();
    await player.setAsset('assets/medias/lecon5/disar.mp3');
    await player.play();
  }
  Future p4() async {
    stopplay();
    await player.setAsset('assets/medias/lecon5/tedat.mp3');
    await player.play();
  }
  Future p5() async {
    stopplay();
  ...
  Future p6() async {
    stopplay();
    await player.setAsset('assets/medias/lecon5/datet.mp3');
    await player.play();
  }
  Future p7() async {
    stopplay();
    await player.setAsset('assets/medias/lecon5/rima.mp3');
    await player.play();
  }
  Future p8() async {
    stopplay();
    await player.setAsset('assets/medias/lecon5/rami.mp3');
    await player.play();
  }
  Future p9() async {
    stopplay();
    await player.setAsset('assets/medias/lecon5/mari.mp3');
    await player.play();
  }
  Future p10() async {
    stopplay();
    await player.setAsset('assets/medias/lecon5/dimar.mp3');
    await player.play();
  }
  Future p11() async {
    stopplay();
    await player.setAsset('assets/medias/lecon5/mardu.mp3');
    await player.play();
  }
  Future p12() async {
    stopplay();
    await player.setAsset('assets/medias/lecon5/dimra.mp3');
    await player.play();
  }
    ...
    setState(() {
      ...
      switch (_radioValue2) {
        case 0:
          ...
          break;
        case 1:
          Fluttertoast.showToast(msg: 'Corrrect !',toastLength: Toast.LENGTH_SHORT);
          correctScore++;
          break;
        case 2:
          Fluttertoast.showToast(msg: 'Incorrect!',toastLength: Toast.LENGTH_SHORT);
    ...
    showDialog(
      ...
      builder: (BuildContext context)
      {
        ...
        return AlertDialog(
          ...
          content:
              Text('«radis» peut se décomposer en deux syllabbes: «ra» et «dis». «radis» commence par «ra» et le «s»  final ne se prononce pas. Certaines  combinaisons le l\'exercice n\'ont aucun sens en français.', style:TextStyle(color:  Colors.black54),),
  ...
  Widget build(BuildContext context) {
          ...
          children: <Widget>[
            ...
            IconButton(icon: Icon(Icons.arrow_forward_ios), onPressed: () {
              //if((_radioValue1==0 && _radioValue2==1)){
                setState(() {
                  Navigator.of(context).pushNamed('/pageRappelc5');
                 /* Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) =>
    ...
    return new Scaffold(
                                 ...
                                 // color:Color.fromRGBO(239, 243, 246, 1.0),
                                  child:Column(
                                    children: <Widget>[
                                        ...
                                        //Text('Badges:'),
                                       // for (int i = 0; i < 5; i++)
                                                     _getExampleBadge(padding: (6).toDouble(),text:"ra + dis"),
                                                   new Padding(
                                                ...
                                                Container(
                                                  ...
                                                  child:
                                                     new Row(
                                                        ...
                                                        _getExampleBadgeElse(padding: (4).toDouble(),text:"disra"),]
                                                  ),),
                                    //photo
                                    //icone de son
                                               /* Container(
                                  ...
                                  // mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                               ...
                                               children: <Widget>[
                                                ...
                                                _getExampleBadgeElse(padding: (4).toDouble(),text:"radis"),]
                                                       ),),
                                    //photo
                                    //icone de son
                                                /* Container(
                                                   ...
                                                   child:
                                                       new Row(
                                                          ...
                                                          new Radio(
                                                           ...
                                                           _getExampleBadgeElse(padding: (4).toDouble(),text:"disar"),]
                                                     ),),
                                    //photo
                                    //icone de son
                                               /*  Container(
                                      ...
                                      Center(
                                          ...
                                          Row(
                                            ...
                                            children: <Widget>[
                                              //Text('Badges:'),
                                              // for (int i = 0; i < 5; i++)
                                              _getExampleBadge(padding: (6).toDouble(),text:"dat + te"),
                                              new Padding(
                                                padding: new EdgeInsets.only(left:8.0),
                                              ),
                                              _iconDisplay2(),
                                         ...
                                         Container(
                                          ...
                                          new Row(
                                              ...
                                              children: <Widget>[
                                                ...
                                                _getExampleBadgeElse(padding: (4).toDouble(),text:"tedat"),]
                                          ),),
                                          //photo
                                          //icone de son
                                            ...
                                            child:
                                             new Row(
                                              ...
                                              children: <Widget>[
                                                ...
                                                _getExampleBadgeElse(padding: (4).toDouble(),text:"datte"),]
                                          ),),
                                          //photo
                                          //icone de son
                                          /*Container(
                                        ...
                                        Container(
                                          ...
                                          new Row(
                                              ...
                                              children: <Widget>[
                                                ...
                                                _getExampleBadgeElse(padding: (4).toDouble(),text:"datet"),]
                                          ),),
                                          //photo
                                          //icone de son
                                      ...
                                      Center(
                                          ...
                                          Row(
                                            ...
                                            children: <Widget>[
                                              //Text('Badges:'),
                                              // for (int i = 0; i < 5; i++)
                                              _getExampleBadge(padding: (6).toDouble(),text:"ma + ri"),
                                              new Padding(
                                                padding: new EdgeInsets.only(left:8.0),
                                              ),
                                              _iconDisplay3(),
                                          ...
                                          Container(
                                            ...
                                            new Row(
                                                ...
                                                children: <Widget>[
                                                  ...
                                                  _getExampleBadgeElse(padding: (4).toDouble(),text:"rima"),]
                                            ),),
                                          //photo
                                          //icone de son
                                          ...
                                          Container(
                                            ...
                                            new Row(
                                                ...
                                                children: <Widget>[
                                                  ...
                                                  _getExampleBadgeElse(padding: (4).toDouble(),text:"rami"),]
                                            ),),
                                          //photo
                                          //icone de son
                                          /*Container(
                                          ...
                                          Container(
                                            ...
                                            new Row(
                                                ...
                                                children: <Widget>[
                                                  ...
                                                  _getExampleBadgeElse(padding: (4).toDouble(),text:"mari"),]
                                            ),),
                                          //photo
                                          //icone de son
                                      ...
                                      Center(
                                          ...
                                          Row(
                                            ...
                                            children: <Widget>[
                                              //Text('Badges:'),
                                              // for (int i = 0; i < 5; i++)
                                              _getExampleBadge(padding: (6).toDouble(),text:"mar + di"),
                                              new Padding(
                                                padding: new EdgeInsets.only(left:8.0),
                                              ),
                                              _iconDisplay4(),
                                          ...
                                          Container(
                                            ...
                                            new Row(
                                                ...
                                                children: <Widget>[
                                                  ...
                                                  _getExampleBadgeElse(padding: (4).toDouble(),text:"dimar"),]
                                            ),),
                                          //photo
                                          //icone de son
                                          ...
                                          Container(
                                            ...
                                            new Row(
                                                ...
                                                children: <Widget>[
                                                  ...
                                                  _getExampleBadgeElse(padding: (4).toDouble(),text:"mardi"),]
                                            ),),
                                          //photo
                                          //icone de son
                                          /*Container(
                                          ...
                                          Container(
                                            ...
                                            new Row(
                                                ...
                                                children: <Widget>[
                                                  ...
                                                  _getExampleBadgeElse(padding: (4).toDouble(),text:"dimra"),]
                                            ),),
                                          //photo
                                          //icone de son
      ...
      floatingActionButton: FloatingActionButton(
        ...
        if((_radioValue1==1 && _radioValue2==1) &&(_radioValue3== 2 && _radioValue4== 1)){
