...
import 'package:exerfrancais/lecon5/l5page10.dart';
...
class Signaturelc5 extends StatefulWidget {
...
class _DrawExampleStae extends State<Signaturelc5> {
        ...
        child: new Row(
          ...
          children: <Widget>[
            ...
            IconButton(icon: Icon(Icons.arrow_forward_ios), onPressed: () {
              ...
              setState(() {
                Navigator.of(context).pushNamed('/page10lc5');
                /*Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) =>
          ...
          child: Stack(
            children: <Widget>[
              Column(
                children: <Widget>[
                  Center(
                    child: Image.asset("assets/medias/lecon5/draw5.png", fit: BoxFit.cover,),
                  ),
                  Expanded(
                    child: Center(
                      child: AspectRatio(
