...
import 'package:exerfrancais/lecon5/l5page9a.dart';
import 'package:badges/badges.dart';
import 'package:just_audio/just_audio.dart';

//import 'package:audioplayers/audioplayers.dart';
class Page8lc5 extends StatefulWidget
{
...
class _Page8State extends State<Page8lc5>
{
  ...
  Future playt1() async {
    stopplay();
    await player.setAsset('assets/medias/lecon5/delatarte.mp3');
    await player.play();
  }
  Future playt2() async {
    stopplay();
    await player.setAsset('assets/medias/lecon5/destartes.mp3');
    await player.play();
  }
  Future playt3() async {
    stopplay();
    await player.setAsset('assets/medias/lecon5/lestartes.mp3');
    await player.play();
  }

  Future playtwo() async {
    stopplay();
    await player.setAsset('assets/medias/lecon5/prov3V5.mp3');
    await player.play();
  }
        ...
        child: new Row(
          ...
          children: <Widget>[
            ...
            IconButton(icon: Icon(Icons.arrow_forward_ios), onPressed: () {
              ...
              stopplay();
                setState(() {
                  Navigator.of(context).pushNamed('/page9alc5');
                  /*Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) =>
                            ...
                            Container(
                              child: Column(
                                  children: <Widget>[
                                    ...
                                    Center(
                                      child:
                                      Image.asset("assets/medias/lecon5/motCrois5Coul.png", fit: BoxFit.cover,),
                                ...
                                Container(
                                  ...
                                  new Row(
                                      ...
                                      children: <Widget>[
                                        ...
                                        _getExampleBadgeElse(padding: (4).toDouble(),text:"de  la tarte."),]
                                  ),),
                                //photo
                                //icone de son
                                ...
                                Container(
                                  ...
                                  new Row(
                                      ...
                                      children: <Widget>[
                                        ...
                                        _getExampleBadgeElse(padding: (4).toDouble(),text:"des tartes."),]
                                  ),),
                                //photo
                                //icone de son
                                /*Container(
                                ...
                                Container(
                                  ...
                                  new Row(
                                      ...
                                      children: <Widget>[
                                        ...
                                        _getExampleBadgeElse(padding: (4).toDouble(),text:"Les tartes"),
                                        new Padding(
                                          padding: new EdgeInsets.only(left:5.0),
                                        ),]
                                  ),),
                            ...
                            children: <Widget>[
                              ...
                              Center(
                                  ...
                                  Row(
                                    mainAxisAlignment: MainAxisAlignment.center,
                                    children: <Widget>[
                                      _getExampleBadge(padding: (6).toDouble(),text:"Prov. 3 V. 5-7"),
                                    ],
                                  )
