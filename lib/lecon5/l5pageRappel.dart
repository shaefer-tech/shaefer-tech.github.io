...
import 'package:exerfrancais/lecon5/l5page3.dart';
import 'package:awesome_dialog/awesome_dialog.dart';
import 'dart:async';

import 'package:just_audio/just_audio.dart';
//import 'package:audioplayers/audioplayers.dart';
class PageRappelc5 extends StatefulWidget
{
...
class _PageRState extends State<PageRappelc5>
{
  ...
  Future p2() async {
    stopplay();
    await player.setAsset('assets/medias/lecon5/di.mp3');
    await player.play();
  }
  ...
  Future p5() async {
    stopplay();
    await player.setAsset('assets/medias/lecon2/si.mp3');
    await player.play();
  }
  Future p6() async {
    stopplay();
  ...
  Future p8() async {
    stopplay();
    await player.setAsset('assets/medias/lecon5/ad.mp3');
    await player.play();
  }
  Future p9() async {
    stopplay();
    await player.setAsset('assets/medias/lecon5/da.mp3');
    await player.play();
  }
  Future p10() async {
    stopplay();
    await player.setAsset('assets/medias/lecon5/ma.mp3');
    await player.play();
  ...
  Future p11() async {
    stopplay();
    await player.setAsset('assets/medias/lecon2/sa.mp3');
    await player.play();
  }
  Future p12() async {
    stopplay();
    ...
    showDialog(
      ...
      builder: (BuildContext context)
      {
        ...
        return AlertDialog(
          ...
          content: Text("Lisez les cases de la Leçon 5. La syllabe est un fractionnement du mot parlé pour analyser de ses constituants.", style:TextStyle(color:  Colors.black54),),
          actions: <Widget>[
            TextButton(
        ...
        child: new Row(
          ...
          children: <Widget>[
            ...
            IconButton(icon: Icon(Icons.arrow_forward_ios), onPressed: () {
              ...
              setState(() {
                Navigator.of(context).pushNamed('/page3lc5');
               /* Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) =>
                                              ...
                                              Container(
                                                ...
                                                new Row(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      Text("di", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 17.0),),
                                                      ]
                                                ),),
                                              //photo
                                              //icone de son
                                              ...
                                              Container(
                                                ...
                                                new Row(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      Text("dis", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 17.0),),
                                              ...
                                              Container(
                                                ...
                                                new Row(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      Text("dit", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 17.0),),
                                                   ]
                                                ),),
                                              //photo
                                              //icone de son
                                              ...
                                              Container(
                                                ...
                                                new Row(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      Text("si", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 17.0),),
                                                     ]
                                                ),),
                                              //photo
                                              //icone de son
                                              ...
                                              Container(
                                                ...
                                                new Row(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      Text("rit", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 17.0),),
                                                      ]
                                                ),),
                                              //photo
                                              //icone de son
                                              ...
                                              Container(
                                                ...
                                                new Row(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      Text("ad", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 17.0),),
                                                     ]
                                                ),),
                                              //photo
                                              //icone de son
                                              ...
                                              Container(
                                                ...
                                                new Row(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      Text("da", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 17.0),),
                                                      ]
                                                ),),
                                              //photo
                                              //icone de son
