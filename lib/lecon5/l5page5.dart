...
import 'package:exerfrancais/lecon5/l5page6.dart';
import 'package:awesome_dialog/awesome_dialog.dart';

import 'package:badges/badges.dart';
import 'dart:async';
//import 'package:audioplayers/audioplayers.dart';
class Page5lc5 extends StatefulWidget
{
...
class _Page5State extends State<Page5lc5>
{
  ...
  _iconDisplay5(){
    if(_radioValue5 != -1) {
      //bool readStatus = _notes[index].getReadState;
      return Icon(((_radioValue5  == 2) ? Icons.check_circle : Icons
          .cancel),
        color: (_radioValue5 == 2) ? Colors.green : Colors.red,);
    }
    ...
    showDialog(
      ...
      builder: (BuildContext context)
      {
        ...
        return AlertDialog(
          ...
          content: Text("Un chiffre est un symbole utilisé pour écrire les nombres. Par analogie avec les mots, on peut dire que les chiffres constituent l’alphabet des nombres.", style:TextStyle(color:  Colors.black54),),
          actions: <Widget>[
           TextButton(
  ...
  Widget build(BuildContext context) {
          ...
          children: <Widget>[
            ...
            IconButton(icon: Icon(Icons.arrow_forward_ios), onPressed: () {
             // if(_radioValue1==0 && _radioValue2==2) {
                setState(() {
                  Navigator.of(context).pushNamed('/page6lc5');
                 /* Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) =>
    ...
    return new Scaffold(
                            ...
                            children: <Widget>[
                              Row(
                                ...
                                children: <Widget>[
                                  ...
                                  Icon(Icons.looks_6, color:Color.fromRGBO(38, 153, 251, 1.0), size: 40.0),
                                  Text("Choisissez le bon chiffre.", style: TextStyle(color:Color.fromRGBO(142, 156, 168, 1.0), fontWeight: FontWeight.bold, fontSize: 17.0),),
                                  //Question/consigne
                                          ...
                                          Center(
                                              ...
                                              Row(
                                                ...
                                                children: <Widget>[
                                                  //Text('Badges:'),
                                                  // for (int i = 0; i < 5; i++)
                                                  _getExampleBadge(padding: (6).toDouble(),text:"un"),
                                                  new Padding(
                                              ...
                                              Container(
                                                ...
                                                new Row(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"1"),]
                                                ),),
                                              //photo
                                              //icone de son
                                              ...
                                              Container(
                                                ...
                                                new Row(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"2"),]
                                                ),),
                                              //photo
                                              //icone de son
                                              ...
                                              Container(
                                                ...
                                                new Row(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"3"),]
                                                ),),
                                              //photo
                                              //icone de son
                                          ...
                                          Center(
                                              ...
                                              Row(
                                                ...
                                                children: <Widget>[
                                                  //Text('Badges:'),
                                                  // for (int i = 0; i < 5; i++)
                                                  _getExampleBadge(padding: (6).toDouble(),text:"deux"),
                                                  new Padding(
                                                    padding: new EdgeInsets.only(left:8.0),
                                                  ),
                                                  _iconDisplay2(),
                                          ...
                                          Center(
                                              ...
                                              Row(
                                                ...
                                                children: <Widget>[
                                                  //Text('Badges:'),
                                                  // for (int i = 0; i < 5; i++)
                                                  _getExampleBadge(padding: (6).toDouble(),text:"trois"),
                                                  new Padding(
                                                    padding: new EdgeInsets.only(left:8.0),
                                                  ),
                                                  _iconDisplay3(),
                                          ...
                                          Center(
                                              ...
                                              Row(
                                                ...
                                                children: <Widget>[
                                                  //Text('Badges:'),
                                                  // for (int i = 0; i < 5; i++)
                                                  _getExampleBadge(padding: (6).toDouble(),text:"quatre"),
                                                  new Padding(
                                                    padding: new EdgeInsets.only(left:8.0),
                                                  ),
                                                  _iconDisplay4(),
                                              ...
                                              Container(
                                                ...
                                                new Row(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"4"),]
                                                ),),
                                              //photo
                                              //icone de son
                                          ...
                                          Center(
                                              ...
                                              Row(
                                                ...
                                                children: <Widget>[
                                                  //Text('Badges:'),
                                                  // for (int i = 0; i < 5; i++)
                                                  _getExampleBadge(padding: (6).toDouble(),text:"cinq"),
                                                  new Padding(
                                                    padding: new EdgeInsets.only(left:8.0),
                                                  ),
                                                  _iconDisplay5(),
                                              ...
                                              Container(
                                                ...
                                                new Row(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      _getExampleBadgeElse(padding: (4).toDouble(),text:"5"),]
                                                ),),
                                              //photo
                                              //icone de son
      ...
      floatingActionButton: FloatingActionButton(
        ...
        if((_radioValue1==0 && _radioValue2==1) && (_radioValue3==2 && _radioValue4==2)&&(_radioValue5==2)) {
          AwesomeDialog(
            context: context,
